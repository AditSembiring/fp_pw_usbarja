...
<body style="font-family: Arial, sans-serif; background: #f4f4f9; margin: 0; padding: 20px;">
    ...
    <h2 style="text-align: center; color: #555;">Edit Team :D</h2>

    <div style="text-align: center; margin-bottom: 20px;">
        <a href="{{ route('team.create') }}" style="background-color: #337ab7; color: #ffffff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; display: inline-block;">Buat Team</a>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th style="background-color: #f0f0f0; border-bottom: 1px solid #ddd; padding: 10px; text-align: left;">NIM</th>
                    <th style="background-color: #f0f0f0; border-bottom: 1px solid #ddd; padding: 10px; text-align: left;">Tugas</th>
            ...
            <tbody>
                ...
                <tr style="background-color: #f9f9f9;">
                    <td style="width: 150px; padding: 10px;">
                        <img src="{{ asset('storage/team/'.$team->image) }}" height="100" style="border-radius: 10px; width: 100%; object-fit: cover;">
                    </td>
                    <td style="width: 200px; padding: 10px;">{{ $team->nama }}</td>
                    <td style="width: 150px; padding: 10px;">{{ $team->nim }}</td>
                    <td style="width: 150px; padding: 10px;">{{ $team->tugas }}</td>
