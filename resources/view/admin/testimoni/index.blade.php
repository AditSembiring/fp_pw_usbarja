...
<body style="font-family: Arial, sans-serif; background: #f4f4f9; margin: 0; padding: 20px;">
    ...
    <h2 style="text-align: center; color: #555;">Edit testimoni</h2>

    <div style="text-align: center; margin-bottom: 20px;">
        <a href="{{ route('testimoni.create') }}" style="background-color: #337ab7; color: #ffffff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; display: inline-block;">Buat testimoni</a>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th style="background-color: #f0f0f0; border-bottom: 1px solid #ddd; padding: 10px; text-align: left;">nama</th>
                    <th style="background-color: #f0f0f0; border-bottom: 1px solid #ddd; padding: 10px; text-align: left;">alamat</th>
                    <th style="background-color: #f0f0f0; border-bottom: 1px solid #ddd; padding: 10px; text-align: left;">pekerjaan</th>
                    <th style="background-color: #f0f0f0; border-bottom: 1px solid #ddd; padding: 10px; text-align: left;">katakata</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr style="background-color: #f9f9f9;">
                    ...
                    <td style="width: 200px; padding: 10px;">{{ $testimoni->nama }}</td>
                    <td style="width: 150px; padding: 10px;">{{ $testimoni->alamat }}</td>
                    <td style="width: 150px; padding: 10px;">{{ $testimoni->pekerjaan }}</td>
                    <td style="width: 150px; padding: 10px;">{{ $testimoni->katakata }}</td>
                    <td style="width: 150px; text-align: center; padding: 10px;">
                        <a href="{{ route('testimoni.edit', $testimoni->id) }}" class="btn btn-warning" style="background-color: #ffc107; color: #ffffff; padding: 5px 10px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none;">Edit</a>
